...
extension NSUIColor {
    public static var randomColor: NSUIColor {
...
extension NSUIColor {
    ...
    public func withRedComponent(_ red: CGFloat) -> NSUIColor {
    ...
    /// - Returns: modified color
    public func withGreenComponent(_ green: CGFloat) -> NSUIColor {
    ...
    /// - Returns: modified color
    public func withBlueComponent(_ blue: CGFloat) -> NSUIColor {
        withRGBComponent(at: 2, value: blue)
    }

    private func withRGBComponent(at index: Int, value: CGFloat) -> NSUIColor {
        var red: CGFloat = -1
        var blue: CGFloat = -1
        var green: CGFloat = -1
        var alpha: CGFloat = 1
        ...
        return NSUIColor(red: rgba[0], green: rgba[1], blue: rgba[2], alpha: rgba[3])
    }
}
